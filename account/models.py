...
class Review(models.Model):
    ...
    doctor = models.ForeignKey(Customuser, related_name="review_doctor", null=True, blank=True,
                               on_delete=models.CASCADE)
    profession = models.ForeignKey(Profession, related_name="review_profession", null=True, blank=True,
                                   on_delete=models.CASCADE)
